...
Public Class FuncionesCliente
    ...
    Public Function getNombre_cliente(ByRef id As Integer)

        Try
            Conectar()
            Dim consulta As String = "SELECT nombre+' '+ apellido_paterno+' '+apellido_materno as 'Nombre' FROM cliente WHERE id_cliente =" & id
