Public Class FuncionesEmpleado
    ...
    Public Sub buscar_empleado(ByRef datagrid As DataGridView, ByRef nombre As String)
        Dim consulta As String = "SELECT id_empleado as 'Numero de Empleado',nombre as 'Nombre',apellido_paterno as 'Apellido PAT',apellido_materno as 'Apellido Mat',sexo as 'Sexo',telefono as 'Telefono',correo_electronico as 'Email',calle as 'Calle',numero_exterior as 'Num Ext',numero_interior as 'Num Int',colonia as 'Colonia',ciudad as 'Ciudad',pais as 'Pais',fotografia as 'Fotografia',sueldo as 'Sueldo',fecha_nacimiento as 'Fecha Nacimiento' FROM empleado WHERE nombre = '" & nombre & "'"
