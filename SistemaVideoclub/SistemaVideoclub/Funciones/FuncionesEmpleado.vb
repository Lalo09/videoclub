Public Class FuncionesEmpleado
    ...
    Public Function getNombre_empleado(ByRef id As Integer)

        Try
            Conectar()
            Dim consulta As String = "SELECT nombre+' '+ apellido_paterno as 'Nombre' FROM empleado WHERE id_empleado = " & id
