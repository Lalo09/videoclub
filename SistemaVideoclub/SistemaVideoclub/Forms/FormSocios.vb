Public Class FormSocios
        ...
        ElseIf socio_seleccionado <> Nothing Then
            ...
            Try
                If dr.Read Then
                    ...
                    If dr(14).ToString = "Baja" Then
                        btn_dar_de_baja.Text = "Dar de alta"
                    End If
                End If
        ...
        If funcionesSocio.existe_socio(socio) Then
            ...
            If txt_telefono.Text <> Nothing And txt_calle.Text <> Nothing And txt_num_ext.Text <> Nothing And txt_colonia.Text <> Nothing And txt_ciudad.Text <> Nothing And txt_pais.Text <> Nothing And pb_foto_cliente.ImageLocation <> Nothing Then
                ...
                Try
                    ...
                    formbuscarSocio.MdiParent = FormMDI.ActiveForm
    ...
    Private Sub btn_generar_credencial_Click(sender As Object, e As EventArgs) Handles btn_generar_credencial.Click
        num_socio_credencia = lbl_idSocio.Text
        imagen_socio = pb_foto_cliente.ImageLocation
        'MsgBox(num_socio_credencia)
        Dim generarCredencial As New FormCredencial
        generarCredencial.Show()
    End Sub

    Private Sub btn_dar_de_baja_Click(sender As Object, e As EventArgs) Handles btn_dar_de_baja.Click
        If lbl_idSocio.Text <> Nothing Then
            If btn_dar_de_baja.Text = "Dar de alta" Then
                funcionesSocio.dar_alta_socio(lbl_idSocio.Text)
                MsgBox("Usuario dado de alta")
            Else
                funcionesSocio.dar_baja_socio(lbl_idSocio.Text)
